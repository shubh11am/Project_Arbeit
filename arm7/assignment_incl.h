...
#ifndef _ARM7_ASSIGNMENT_INCL_H_
#define _ARM7_ASSIGNMENT_INCL_H_
  ...
  public:
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    explicit WriteBackInfo( LLIR_Register *resultRegister );
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    explicit WriteBackInfo( const ARM_LValue &writeTo );
...
/*!
  ...
  @param[in,out] wb A reference to a write-back info describing the required
                    memory access.
  @return A LLIR register where the final result is stored.
