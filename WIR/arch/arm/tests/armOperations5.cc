...
int main( void )
{
  ...
  WIR_Operation o(
    ARM_Base::OpCode::ADD, ARM_Base::OperationFormat::CRRRAR_1, WIR_ConditionFieldParameter( ARM_Base::Condition::eq ),
  ...
  ufAssertT(
    regP.getAddressingMode().isCompatible(
      ARM_Base::AddressingMode::lsl, ARM_Base::OperationFormat::CRRRAR_1,
      ARM_Base::OpCode::ADD ),
